...
// =========================================================
import imgAutoestima from '../assets/images/portada-podcast-ansiedad.webp';
import imgAnsiedad from '../assets/images/autoestima-portada.webp';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-14">
            ...
            {articulos.map((post) => (
              ...
              >
                ...
                <div className="relative w-full h-[240px] bg-brand-main/20 overflow-hidden">
