      ...
      <main className="flex-grow">
        ...
        <section className="bg-brand-primary py-16 px-6 flex items-center justify-center min-h-[85vh]">
          <div className="max-w-[1200px] w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              <a href="/contacto" className="inline-block bg-brand-orange hover:bg-brand-secondary text-brand-white px-10 py-3.5 rounded-full font-bold shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                ¡EMPECEMOS!
              </a>
            </div>
        ...
        <section className="bg-brand-orange py-14 px-6 flex items-center justify-center">
          <div className="max-w-[900px] flex flex-col items-center text-center gap-8">
            ...
            <a href="/contacto" className="inline-block bg-brand-secondary text-brand-white hover:bg-brand-dark px-10 py-3.5 rounded-full font-bold shadow-md transition-all duration-300 transform hover:-translate-y-1">
              ¡Empecemos!
            </a>
          </div>
        </section>
